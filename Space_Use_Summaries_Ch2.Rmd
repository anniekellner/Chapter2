...
# Is there an association between age and the bonepile
...
bpt2 <- bpt2 %>% # df with start and end dates
  mutate(bonepile = if_else(
    id == "pb_20492.2008" | id == "pb_20520.2012" | id == "pb_20735.2009" | id == "pb_20966.2008" | 
      id == "pb_20982.2008" | id == "pb_32282.2008" | id == "pb_32366.2011" | id == "pb_32608.2008",
    "Kaktovik", "Cross"
...
# Do the bears' time intervals at the bonepile overlap the harvest dates?
# interval() works for ymd and ymd_hms

# I can't figure out best way to match and determine whether intervals overlap. Maybe go to Stack Overflow. 
