...
ua <- readRDS(here("Data", "Derived-data", "DFs", "OG", "allUA_12_15_23.Rds"))
...
tm_shape(islands) + 
  ...
  tm_shape(sample1) + 
  tm_symbols(size = 0.25, col = "on_island") # looks good 12-15-23


# ----------- Save data ------------------------------ #

#saveRDS(ua, here("Data", "Derived-data", "DFs", "OG", "uaSF_12-15-23.Rds")) # save as spatial object
