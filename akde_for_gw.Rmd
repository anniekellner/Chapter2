...
This is what the 95th AKDE looks like:
...
UD2w <- akde(pbx.t,M.OUF,weights=TRUE) #The Ornstein-Uhlenbeck-F (OUF) model m.ouf introduces an additional autocorrelation timescale for the animal’s velocity, so that it more closely matches the initial behavior of the variogram.
...
```
This is what the 50th AKDE looks like:
