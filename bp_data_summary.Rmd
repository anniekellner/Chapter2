...
b2 <- b %>% distinct() # Number of points eliminated is same as bonepile, so duplicate bp pts for 20525.2013 were eliminated

#saveRDS(b2, here("Data", "Derived-data", "DFs", "OG", "OG.Rds"))
# Bonepile points 
...
# ERROR: 
  #in as.ltraj(xy = u[, c("Xaa", "Yaa")], date = u$datetime, id = as.character(u$id)) :
  # non unique dates for a given burst

# Solution:
  # 20525.2013 appears to be duplicated
