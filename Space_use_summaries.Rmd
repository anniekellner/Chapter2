...
## Plot trajectories - Time v. Distance traveled

```{r}

plotltr(traj.one, "dt/3600")
...
# Use cutltraj to cut any burst relocations such that foo(dt) is true

traj.one <- cutltraj(traj.one, 'foo(dt)', nextr = TRUE)
